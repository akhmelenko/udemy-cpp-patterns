...
{
    std::shared_ptr<Specification<T>> first;
    std::shared_ptr<Specification<T>> second;

public:
    explicit SpecificationAnd(
        const std::shared_ptr<Specification<T>> first,
        const std::shared_ptr<Specification<T>> second)
